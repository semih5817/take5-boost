    ...
    <div className="w-full bg-[#0A0E1A] rounded-2xl border border-slate-700 overflow-hidden">
      ...
      <div className="p-6">
        ...
        {activeTab === 'gamification' && (
          <>
            <h2 className="text-2xl font-bold mb-6 text-white">🎮 Système de Gamification</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {badges.map((badge) => {
                  ...
                  return (
                    <Card 
                      key={badge.id} 
                      className={`p-6 border-2 bg-slate-800/50 transition-all ${
                        badge.locked ? 'opacity-40' : 'hover:scale-105'
                      } ${badge.current ? 'border-purple-500' : 'border-slate-700'}`}
                    >
                      <div className="flex flex-col items-center text-center">
                        <div className="w-16 h-16 rounded-full flex items-center justify-center mb-3 bg-purple-500/10">
                          {badge.locked ? (
                        ...
                        <h3 className="font-bold mb-1 text-white">{badge.name}</h3>
                        <p className="text-xs text-slate-400 mb-3">{badge.requirement}</p>
                        {!badge.locked && (
                          <div className="w-full">
                            ...
                            <p className="text-xs text-slate-400 mt-1">{badge.progress}%</p>
                          </div>
                        )}
                      </div>
                    </Card>
