    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0f0c29] via-[#302b63] to-[#24243e] text-white">
      ...
      <div className="container mx-auto px-5 max-w-7xl">
        ...
        <section id="contact" className="py-20">
          <h2 className="text-3xl md:text-5xl font-bold mb-5 text-center">Prêt à commencer ?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
            ...
            <div className="p-6 md:p-8 bg-[#161b34]/80 border-2 border-[#4F5EFF]/30 rounded-2xl flex flex-col justify-center">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full px-8 py-6 text-base font-bold bg-gradient-to-r from-[#667eea] to-[#4F5EFF] hover:shadow-lg hover:shadow-[#4F5EFF]/40 transition-all rounded-xl"
                >
              ...
              {showSuccess && (
                <div className="mt-5 bg-gradient-to-r from-green-500 to-emerald-600 text-white py-5 px-6 rounded-xl font-semibold animate-fade-in text-center">
                  ✓ Merci ! Consultez votre boîte email.
                </div>
              )}
            ...
            {/* WhatsApp Contact */}
            <div className="p-6 md:p-8 bg-[#161b34]/80 border-2 border-[#25D366]/30 rounded-2xl flex flex-col justify-center text-center">
              <h3 className="text-xl font-bold mb-4">💬 Par WhatsApp</h3>
              ...
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white font-bold rounded-xl hover:shadow-lg hover:shadow-[#25D366]/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
