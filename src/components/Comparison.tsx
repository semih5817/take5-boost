        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="flex items-center justify-center">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-secondary mx-auto mb-4 flex items-center justify-center shadow-primary animate-pulse">
                <ArrowRight className="w-8 h-8 text-white" />
              </div>
              <p className="font-bold text-lg gradient-text">Avec Take 5</p>
            </div>
          </div>
              ...
              {[
                ...
                <li key={index} className="flex items-start gap-2">
                  ...
                  <div className="flex-1 flex items-center justify-between gap-2">
                    ...
                    <Badge className="bg-green-600 text-white text-xs">{item.badge}</Badge>
                  </div>
                </li>
              ))}
            </ul>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <Card key={index} className="p-6 hover:shadow-elegant transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-secondary mb-4 flex items-center justify-center text-2xl font-bold text-white">
                {benefit.number}
              </div>
