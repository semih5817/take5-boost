...
export const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Oui, absolument ! L'engagement de 12 mois permet de bénéficier du tarif préférentiel de 29,90€/mois. Après cette période, vous pouvez résilier en 1 clic depuis votre espace client, sans frais ni pénalités."
    },
    {
